...
public class Vector3d {
    ...
    public Vector3d normalize(){
        return div(Math.max(length(), Double.MIN_VALUE));
    }
    ...
    @NotNull
    public static Vector3d cross(@NotNull Vector3d vector1, @NotNull Vector3d vector2){
    ...
    public @NotNull Vector3d set(@NotNull Vector3d other){
        return set(other.x, other.y, other.z);
    }

    public @NotNull Vector3d set(double x, double y, double z){
        this.x = x;
        this.y = y;
        this.z = z;
        return this;
    ...
    public @NotNull org.joml.Vector3f toJoml(){
